...
public:
    ...
    cv::Mat getPositionInCamCoordinates() const;
...
protected:
    ...
    cv::Mat rvec, rotM, tvec, positionCamCoordinates;  //rotation vector and translation vector from CameraCoordinates to WorldCoordinates
